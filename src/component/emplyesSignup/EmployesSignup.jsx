                 ...
                 <div>
                    <div className='sign-up p-2'>
                        ...
                        <div className='input_field mb-2'>
                            ...
                            <div className='input_field mb-2'>
                                <input onBlur={(e) => setEmployeeDetails({ ...employeeDetails, institution: e.target.value })} id='currentCompany' type="text" className='w-100 bg-transparent border-white' />
                            </div>
                        </div>
                        ...
                        <div className='input_field mb-2'>
                            ...
                            <div className='input_field mb-2'>
                                <input onBlur={(e) => setEmployeeDetails({ ...employeeDetails, currentPosition: e.target.value })} id='currentPosition' type="text" className='w-100 bg-transparent border-white' />
                            </div>
                        </div>
                        ...
                        <div className='input_field mb-2'>
                            ...
                            <div className='input_field mb-2'>
                                <input onBlur={(e) => setEmployeeDetails({ ...employeeDetails, registrationNumber: e.target.value })} id='registrationNumber' type="number" className='w-100 bg-transparent border-white' />
                            </div>
                        </div>
